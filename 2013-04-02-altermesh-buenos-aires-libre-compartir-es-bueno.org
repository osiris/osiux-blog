...
** Hay equipo!
   ...
   |--------------+-------+-------+--------+--------|
   | TL-WDR3500ND | 8mb   | 128mb | 2.4Ghz | 5Ghz   |
   | TL-MR3220    | 4mb   | 32mb  | 2.4Ghz | -      |
   | TL-WR842ND   | 8mb   | 32mb  | 2.4Ghz | -      |
...
** Graficando la red
   ...
   - Descargar imagen en alta resolución: [[file:img/osiux-network.png]]
...
[fn:redes-libres] http://wiki.redeslibres.org

...
** Topología, redes y Subredes
   ...
   - centralizada
     ...
     #+BEGIN_SRC ditaa :file img/redes-centralizadas.png :cmdline -E :exports result
       +---+             +---+
       | A +-----+ +-----+ B |
       +---+     | |     +---+
                ++-++
   ...
   - descentralizada
     ...
     #+BEGIN_SRC ditaa :file img/redes-descentralizadas.png :cmdline -E :exports result
       +---+             +---+  +---+             +---+
       | A +-----+ +-----+ B |  | F +-----+ +-----+ G |
       +---+     | |     +---+  +---+     | |     +---+
                ++-++                    ++-++
   ...
   - en malla o /mesh/
     ...
     #+BEGIN_SRC ditaa :file img/redes-mesh.png :cmdline -E -S :exports result
       +---+             +---+  +---+             +---+
       | A +-----+ +-----+ B +--+ F +-------------+ G |
       ++-++     | |     ++--+  +--++             +--++
        | |     ++-++     |        |     +---+       |
...
*** Red de 4 equipos
    ...
    #+BEGIN_SRC ditaa :file img/redes-lan.png :cmdline -E :exports result
      -----+---------+---------+---------+-----
           |         |         |         |
           |         |         |         |
         +-+-+     +-+-+     +-+-+     +-+-+
...
*** =B= dice, *necesito una IP!*
    ...
    #+BEGIN_SRC ditaa :file img/redes-dhcp-discover.png :cmdline -E :exports result
      <----*---------*---------*---------*---->
           |         ^         |         |
           v         |         v         v
         +-+-+     +-+-+     +---+     +---+
...
** protocolos
   ...
   #+BEGIN_SRC ditaa :file img/redes-protocolos.png :cmdline -E :exports resul
                                +-------+
                                | Data  |          <-- Aplicación
                                |       |
                                |       |
